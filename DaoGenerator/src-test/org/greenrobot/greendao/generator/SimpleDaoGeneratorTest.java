...
public class SimpleDaoGeneratorTest {
    ...
    public void testMinimalSchema() throws Exception {
        ...
        Entity addressEntity = schema.addEntity("Cine");
        Property idProperty = addressEntity.addIdProperty().getProperty();
        addressEntity.addStringProperty("nombre").notNull();
        addressEntity.addStringProperty("direccion").notNull();
       // assertEquals(1, schema.getEntities().size());
        ...
        File daoFile = new File(outputDir, "com/cinemax/" + addressEntity.getClassName() + "Dao.java");
        daoFile.delete();
